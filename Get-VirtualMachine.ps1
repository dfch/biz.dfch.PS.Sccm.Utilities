...
(
	...
	try
	{
		...
		if( ! $CMDevice )
		{
			"Failed to retrieve CMDevice";
		}
		$OutputParameter = $CMDevice;
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-VirtualMachine; } 


# SIG # Begin signature block
# MIIW3AYJKoZIhvcNAQcCoIIWzTCCFskCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUyEf+99M8ryhDe+u/WeTuUZFl
# hjigghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQP3wo50/+tLhO3ool7
# DoHuOr/QkDANBgkqhkiG9w0BAQEFAASCAQAEOsaXZQn+ItiLrHcpcKqzNZUUllT3
# XRL4o9J+WmeEsqlHiyPpBItJi8JAu23U8OOm0roxePKeYA3NozxXCXiCa2b4Pr2m
# GoUtjOQduNiZEMl1Bm6SVHjSHl5H+bjaMZ3II0EopFgILkrLtOhqVL/YDoTxFtut
# 6QqA5o+LdTdRXGb21p2jTO+z4WNlKn3O2GeJzv/zhZ0NRkKiS6HOAiBpsEb/qm5U
# zaCSM+wBat2MPLZgCxDFAwMSTH68eFZXyzrspq/6Iva0ycXTDQTZMEpguUYEh/nr
# E7PND/t+9mmJIcLIv5mZOmesF6e6Vu0ibH8BFTsLX24dzjCThdUjuoNMoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE0MTEy
# NjA3Mzg1MFowIwYJKoZIhvcNAQkEMRYEFJF98GGFiKkS37jiZHuB6MjTc81dMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQCCUIk30wPgsukeRDIgS9cu
# F7I6iP9UxOmTh7YnIKA9dmxQ6AOMXfLm48OgJ/I6Yok+K4YPbQ1ob8utgdpSEMhJ
# J0TKONHCaXUaoztb4wcMeDlXaPygqMA2Tu10TPYpISOBIR6GmSpGaKdX6Esfcx9S
# adQOXObE/yOeHyevD94lICalzbiMKfDeFWkRjNxKJuTNPQdvyoJnAZ/+P5snTeYh
# NohDoNFi59YlhGoZ2uhP3eQ47kQyzMha2psfVlg+LD0BGzX/jFPso9aYiaOuCMtF
# mFdAXwn+dYFD0p3IIoMSPKhsMrLRXCf6fxaX6wJSof/x1t/ExKXffPhbu85Mw4R9
