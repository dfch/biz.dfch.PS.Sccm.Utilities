...
This Cmdlet returns true on success. On failure Cmdlet returns $null.



.PARAMETER strADName

The Name of the CMDevice
...
Remove-VirtualMachine -strADName 'VM01' -SCCMSiteCode SITE1


.LINK

Online Version: http://dfch.biz/biz/dfch/PS/Sccm/Utilities/Remove-VirtualMachine/
...
#>
	...
	try{
		...
		Enter-SCCMSite -SiteCode $SCCMSiteCode
		
		$CMDevice = Get-CMDevice -Name $strADName
		if( $CMDevice )
		{
			Log-Debug -fn $fn -msg ('{0} CMDevice successfully retrieved - SCCMSite: {1}' -f $strADName, $SCCMSiteCode )
			Log-Debug -fn $fn -msg ('{0} CMDevice init delete: SMSID: {2} - SCCMSite: {1}' -f $strADName, $SCCMSiteCode, $CMDevice.SMSID )
			
			Remove-CMDevice -DeviceName $strADName -Confirm:$false -Force -ea Stop
			
		} else {
			Log-Debug -fn $fn -msg ('{0} No CMDevice retrieved - SCCMSite: - {1}' -f $strADName, $SCCMSiteCode )
		}
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Remove-VirtualMachine; } 


# SIG # Begin signature block
# MIIW3AYJKoZIhvcNAQcCoIIWzTCCFskCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUkTkn5lYuZBr2Q2hbdj0WLv78
# r+ygghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQDYlT502LsUoVj6UlD
# bpmRrAHx9TANBgkqhkiG9w0BAQEFAASCAQAxzYuCHop8Kt1dsnytstcCirgbeSur
# /L0SplYHID9qlp6f+wAT+flI4bmutma/EDl5v2wJ5wL0dHBo9hyZexGM1gdK1pbb
# r8phpjIAwv0GH0DjPpQWTtMAen2fy1a/YzqTiY19ociDftfEpInunoCjweN+Rb5F
# x90X9BTbMqrtJOv5FgTwWhXBjsmOIZHvS5dSOqaw2onMKC4Swc4IENN+zJ4mKmPY
# psz2IMBxqBzacoa5Fidi6euea2Ny2SGBVoIRset7h+IS7/wH8stwgJj6N0Qom+iP
# 1I3/rapgLxImwHqzvYQt3BimhOfKvZ8TCitMFwYXaHQ7ZfwQUrLjAj7PoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE0MTEy
# NjA3Mzg1MVowIwYJKoZIhvcNAQkEMRYEFFNfzV2CKIFH6lhG0YXIeq+IbnvHMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQB1sAqSHzpN35y6T9ubbIaN
# dGGZxpZRmljm8he5T26WPvPBnDi8cmQj5j/BMY8q98gSeDoMHxRoxLsO0SIxUftt
# XTdoYBuoFY5LAfeW+1UwTxjxr4v/pj7erGNundH71+/lr+ByUNDmCp/pu/6gOdJQ
# cR0/J8mW6+AGXbh62aH7qnwpe8/2oHzMTfQzyl9KEmqJUPVxnahEuniKxn+Tq5iF
# EA4tp034DWPHWQjwt3BKHOUr5kERojvxt1Glk3lh3TgJsAXbiGr1NaenQ9a0BMVb
# Hh7uPlnVzkqW8mcmHTi4Uxydy6pdP2hYTkhqs+WYpUnNu54rrzj9na4jA3Dmj3MB
